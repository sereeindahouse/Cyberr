...
for (let index = 0; index < files.length; index += 1) {
  ...
  notes.push({ id: 10000 + index + 1, title: base, room: folder || "KS", source: info.source, stage: info.stage, tags: [...new Set(tags)], status: "Draft", readTime: `${Math.max(1, Math.ceil(content.length / 1800))} min`, date: "KS import", excerpt: `KS source: ${relativePath}`, content, sourcePath: relativePath });
